        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container-flex">
                    <div align="right">
                        <a href="{{ route('showapplyclaim')}}" class="btn btn-primary py-8 fs-4 mb-4 rounded-2">Apply Claim</a>
                      </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="bulan" id="bulan" onChange="getdata(this.value,{{ $user->icno }})">
...
<script src="assets/libs/jquery-3.6.0.min.js"></script>
  ...
  <script>
    function getdata() {
        ...
        console.log('Tahun :' + tahun + ' Bulan :' + bulan + ' IC :' + ic);

        $.ajax({
            url: "{{ route('getclaims') }}", // Route Laravel untuk dapatkan data
            type: "GET",
            data: { tahun: tahun, bulan: bulan, ic: ic },
