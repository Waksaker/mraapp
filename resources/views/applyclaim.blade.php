...
<head>
  ...
  <style>
    ...
    select {
        ...
        appearance: none !important; /* Untuk buang default style */
...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
    ...
    <div class="row">
        <div class="col-12">
        <div class="card">
            <div class="card-header">APPLY CLAIM
            ...
            <div class="card-body">
                <form action="{{ route('applyclaims') }}" method="post">
                    @csrf
                    <div class="customer_records">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control mb-3" id="noic" name="noic" value="{{ $user->icno ?? '-' }}">
                            </div>
                        </div>
                    </div>
